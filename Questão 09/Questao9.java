...
public class Questao9 {
	...
	/**
	 * Método que utiliza a busca em largura para calcular a distancia de um 
	 ...
	 * para o vertice vj é igual a distancias[j].
	 * @param g
	 * @param v
	 */
	...
	/**
	 * Método usado para calcular a distancia entre dois vertices no grafo.
	 * @param g
	 * @param i
	 * @param j
	 */
	public static void distanciaEntreDoisVertcies(Grafo g, int i, int j) {
		...
		if (distancias[j] == INFINITO)
			System.out.println("\n Não existe um caminho entre o vertice (" + i + ") e o vertice (" + j + ")");
		else
			System.out.println("\n A distância entre o vertice (" + i + ") e o vertice (" + j + ") é: " + distancias[j]);
	}
	...
	public static void main(String[] args) {
		...
		System.out.print(" Qual o primeiro vértice ? ");
		int v1 = scan.nextInt();
		...
		System.out.print("\n Qual o segundo vértice ? ");
		int v2 = scan.nextInt();
		
		while(v2 < 0 || v2 > 9){
			System.out.println(" Vértice inválido!");
			System.out.print(" Qual o segundo vértice ? ");
			v2 = scan.nextInt();
		}
